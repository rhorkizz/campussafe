-- Import this file into the database your host already created (phpMyAdmin → select DB → Import).
-- Do not use the top of schema.sql (CREATE DATABASE / USE) on shared hosting — you lack permission.
